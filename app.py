...
def process_recommendations(hits, C, m, P_max, lambda_popularity=0.5, lambda_year=200):
    recommendations = []
    for hit in hits:
        rec = hit['_source']
        ...
        wr = calculate_weighted_rating(v, R, P, C, m, P_max, release_year, 2024, lambda_popularity, lambda_year)
...
def get_hybrid_recommendations(user_id, content_id, alpha=0.3, num=20,
